...
class PowerModel(ABC):
    ...
    # @abstractmethod
    # def measure_power_requirement(self) -> PowerMeasurement:
    #     """Return the requirement power usage."""
    #
    @abstractmethod
...
class PowerMeter:
    ...
    # JABER
    def get_final_measurement(self):
        # Assuming the measurements are stored internally, return the final measurements
